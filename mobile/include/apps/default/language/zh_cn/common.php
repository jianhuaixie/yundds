...
$_LANG['order_submit_back'] = '<span class="home">%s</span> <span class="usercenter">%s</span>';
...
$_LANG['my_setting'] = '个人设置';

$_LANG['my_tuiguang'] = '推广中心';
$_LANG['my_renqi'] = '我的人气';
$_LANG['my_shouyi'] = '推广收益';
$_LANG['earnings_overview'] = '结算概况';
$_LANG['earnings_detail'] = '收益明细';
$_LANG['tuiguang_order'] = '推广订单';
$_LANG['tuiguang_order1'] = '待收货订单';
$_LANG['tuiguang_order2'] = '已收货订单';
$_LANG['tuiguang_order3'] = '换货中订单';
$_LANG['tuiguang_order4'] = '已退货订单';
$_LANG['paihang'] = '排行榜';
$_LANG['paihang_detail'] = '排行榜详情';

$_LANG['to_receive_list'] = '待收货';

$_LANG['to_comment_list'] = '待评价';

$_LANG['to_return_list'] = '退换货';

$_LANG['no_msg'] = '暂无记录';

/*物流信息*/
//ecshop后台中显示的快递公司名称
$_LANG['postcom'][0]['name'] = '中国邮政';
$_LANG['postcom'][1]['name'] = '申通快递';
$_LANG['postcom'][2]['name'] = '圆通速递';
$_LANG['postcom'][3]['name'] = '顺丰速运';
$_LANG['postcom'][4]['name'] = '天天快递';
$_LANG['postcom'][5]['name'] = '韵达快递';
$_LANG['postcom'][6]['name'] = '中通快递';
$_LANG['postcom'][7]['name'] = '龙邦物流';
$_LANG['postcom'][8]['name'] = '宅急送';
$_LANG['postcom'][9]['name'] = '全一快递';
$_LANG['postcom'][10]['name'] = '汇通速递';
$_LANG['postcom'][11]['name'] = '民航快递';
$_LANG['postcom'][12]['name'] = '亚风速递';
$_LANG['postcom'][13]['name'] = '快捷速递';
$_LANG['postcom'][14]['name'] = '华宇物流';
$_LANG['postcom'][15]['name'] = '中铁快运';