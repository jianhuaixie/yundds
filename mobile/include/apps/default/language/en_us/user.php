 ...
 * File name：user.php
 * ----------------------------------------------------------------------------
 * Function description：User Center language file
 * ----------------------------------------------------------------------------
...
$_LANG['clear_history'] = "Empty";
$_LANG['not_history'] = "No browsing history, click";
$_LANG['enter'] = "Enter";
$_LANG['scan_goods'] = "Browse goods";
$_LANG['view_more'] = "See more";
/* 用户菜单 */
$_LANG['label_welcome'] = 'Welcome';
$_LANG['label_profile'] = 'My Information';
$_LANG['edit_password'] = 'Change password';
...
$_LANG['user_service'] = 'Customer service';
$_LANG['user_service_list'] = 'Message center';
$_LANG['user_history'] = 'Browse history';
...
$_LANG['not_pay_list'] = 'Unpaid order list';
...
$_LANG['order_tracking'] = 'Order tracking';
...
/* 取回密码 */
$_LANG['label_get_password'] = 'You can pass';
$_LANG['photo_number'] = 'Cell phone number';
$_LANG['safe_question'] = 'safe question';
$_LANG['email'] = 'email';
$_LANG['get_password'] = 'Retrieve password';
$_LANG['reset_password'] = 'Reset password';
$_LANG['back_home_lnk'] = 'Return home';
...
$_LANG['get_password_by_mobile'] = 'Fimd back your password by phone';
$_LANG['back_retry_answer'] = 'back and retry';
$_LANG['no_mobile'] = 'Please enter your phone number.';
$_LANG['no_username'] = 'Please enter a user name';
$_LANG['no_emaill'] = 'Please enter your email';
$_LANG['no_code'] = 'Please enter the verification code';
$_LANG['code'] = 'The verification code';
$_LANG['no_password'] = 'Please enter a password';
$_LANG['get_code'] = 'Get verification code';

/* 登录 注册 */
$_LANG['mobile_login'] = 'Mobile regist';
$_LANG['emaill_login'] = 'Email regist';

$_LANG['login'] = 'Login';
$_LANG['sms_code_error'] = 'Verification code does not match';
$_LANG['mobile_code_error'] = 'Mobile verification code error';
$_LANG['register_back'] = 'Re registration';
$_LANG['msg_mobile_blank'] = 'Phone number can not be empty';
$_LANG['msg_mobile_exists'] = 'Mobile phone number already exists';
$_LANG['next'] = 'Next';
...
$_LANG['now_landing'] = 'Now landing';
$_LANG['free_registered'] = 'Free regist';
$_LANG['third_login'] = 'Log in using a cooperative account';
$_LANG['no_register_auth'] = 'Do not have to register the plug-in, please contact the background administrator';
$_LANG['msg_un_blank'] = 'Username is blank';
$_LANG['msg_mast_length'] = 'User name must be 3-15 character';
...
$_LANG['agreement'] = "I have read and agree with《<a href=\"\".url(\'article/info\', array(\'aid\'=>6)).\"\" style=\"color:blue\" target=\"_blank\">User agreement</a>》";
...
$_LANG['passport_js']['username_longer'] = '- User name cannot exceed 15 characters.';
...
$_LANG['can_not_empty'] = 'Can\'t be empty';
