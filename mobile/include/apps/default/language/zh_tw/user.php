...
$_LANG['user_service'] = '客戶服務';
$_LANG['user_service_list'] = '消息中心';
$_LANG['user_history'] = '浏覽記錄';
...
$_LANG['process_notic'] = '會員備注';
$_LANG['admin_notic'] = '管理員備注';
...
$_LANG['account_js']['process_desc'] = '請輸入您此次操作的備注信息！';
...
$_LANG['process_desc'] = '處理備注';
$_LANG['describe'] = '訂購描述';
$_LANG['contact_username'] = '聯系人';
$_LANG['contact_phone'] = '聯系電話';
...
$_LANG['booking_js']['contact_username_empty'] = '請輸入聯系人姓名！';
$_LANG['booking_js']['email_empty'] = '請輸入聯系人的電子郵件地址！';
$_LANG['booking_js']['email_error'] = '您輸入的電子郵件地址格式不正確！';
$_LANG['booking_js']['contact_phone_empty'] = '請輸入聯系人的電話！';
...
$_LANG['profile_js']['both_password_error'] = '您現兩次輸入的密碼不壹致！';
...
$_LANG['edit_address'] = '編輯收貨地址';
$_LANG['confirm_edit'] = '確認修改';

$_LANG['confirm_drop_address'] = '妳確認要刪除該收貨地址嗎？';

/* 會員密碼找回 */
$_LANG['username_and_email'] = '請輸入您注冊的用戶名和注冊時填寫的電子郵件地址。';
$_LANG['enter_new_password'] = '請輸入您的新密碼';
$_LANG['username_no_email'] = '您填寫的用戶名與電子郵件地址不匹配，請重新輸入！';
$_LANG['fail_send_password'] = '發送郵件出錯，請與管理員聯系！';
...
$_LANG['get_question_username'] = '請輸入您注冊的用戶名以取得您的密碼提示問題。';
$_LANG['no_passwd_question'] = '您沒有設置密碼提示問題，無法通過這種方式找回密碼。';
$_LANG['input_answer'] = '請根據您注冊時設置的密碼問題輸入設置的答案';
...
$_LANG['password_js']['both_password_error'] = '您兩次輸入的密碼不壹致！';

/* 會員留言 */
$_LANG['message_title'] = '主題';
$_LANG['message_time'] = '留言時間';
$_LANG['reply_time'] = '回複時間';
$_LANG['shopman_reply'] = '店主回複';
...
$_LANG['confirm_remove_msg'] = '妳確實要徹底刪除這條留言嗎？';

/* 會員紅包 */
$_LANG['bonus_is_used'] = '妳輸入的紅包妳已經領取過了！';
$_LANG['bonus_is_used_by_other'] = '妳輸入的紅包已經被其他人領取！';
$_LANG['bonus_add_success'] = '您已經成功的添加了壹個新的紅包！';
$_LANG['bonus_not_exist'] = '妳輸入的紅包不存在';
...
$_LANG['no_priv'] = '妳沒有權限操作他人訂單';
$_LANG['buyer_cancel'] = '用戶取消';
$_LANG['cancel'] = '取消訂單';
$_LANG['pay_money'] = '付款';
$_LANG['view_order'] = '查看訂單';
$_LANG['order_tracking'] = '訂單跟蹤';
$_LANG['received'] = '確認收貨';
$_LANG['ss_received'] = '已完成';
$_LANG['confirm_cancel'] = '您確認要取消該訂單嗎？取消後此訂單將視爲無效訂單';
$_LANG['merge_ok'] = '訂單合並成功！';
$_LANG['merge_invalid_order'] = '對不起，您選擇合並的訂單不允許進行合並的操作。';
$_LANG['select'] = '請選擇...';
$_LANG['order_not_pay'] = "妳的訂單狀態爲 %s ,不需要付款";
$_LANG['order_sn_empty'] = '合並主訂單號不能爲空';
$_LANG['merge_order_notice'] = '訂單合並是在發貨前將相同狀態的訂單合並成壹新的訂單。<br />收貨地址，送貨方式等以主定單爲准。';
$_LANG['order_exist'] = '該訂單不存在！';
$_LANG['order_is_group_buy'] = '[團購]';
$_LANG['order_is_exchange'] = '[積分商城]';
$_LANG['gb_deposit'] = '（保證金）';
$_LANG['notice_gb_order_amount'] = '（備注：團購如果有保證金，第壹次只需支付保證金和相應的支付費用）';
$_LANG['business_message'] = '發送/查看商家留言';
$_LANG['pay_order_by_surplus'] = '追加使用余額支付訂單：%s';
...
$_LANG['current_os_already_confirmed'] = '當前訂單已經被確認，無法取消，請與店主聯系。';
$_LANG['current_ss_not_cancel'] = '只有在未發貨狀態下才能取消，妳可以與店主聯系。';
$_LANG['current_ps_not_cancel'] = '只有未付款狀態才能取消，要取消請聯系店主。';
$_LANG['confirm_received'] = '妳確認已經收到貨物了嗎？';

/* 合並訂單及訂單詳情 */
$_LANG['merge_order_success'] = '合並的訂單的操作已成功！';
$_LANG['merge_order_failed']  = '合並的訂單的操作失敗！請返回重試！';
...
$_LANG['order_user_not_same'] = '要合並的兩個訂單不是同壹個用戶下的';
$_LANG['from_order_sn'] = '第壹個訂單號：';
$_LANG['to_order_sn'] = '第二個訂單號：';
$_LANG['merge'] = '合並';
$_LANG['notice_order_sn'] = '當兩個訂單不壹致時，合並後的訂單信息（如：支付方式、配送方式、包裝、賀卡、紅包等）以第二個爲准。';
$_LANG['subtotal'] = '小計';
$_LANG['goods_price'] = '商品價格';
$_LANG['goods_attr'] = '屬性';
$_LANG['use_balance'] = '使用余額';
...
$_LANG['confirm_time'] = '確認于 %s';
$_LANG['pay_time'] = '付款于 %s';
$_LANG['shipping_time'] = '發貨于 %s';
...
/* 取回密碼 */
$_LANG['label_get_password'] = '您可通過';
$_LANG['photo_number'] = '手機號';
$_LANG['safe_question'] = '安全問題';
$_LANG['email'] = '電子郵件';
$_LANG['get_password'] = '找回密碼';
$_LANG['reset_password'] = '重置密碼';
$_LANG['back_home_lnk'] = '返回首頁';
$_LANG['get_password_lnk'] = '返回獲取密碼頁面';
$_LANG['get_password_by_question'] = '問題找回';
$_LANG['get_password_by_mail'] = '郵件找回';
$_LANG['get_password_by_mobile'] = '短信找回';
$_LANG['back_retry_answer'] = '返回重試';
$_LANG['no_mobile'] = '請輸入手機號碼';
$_LANG['no_username'] = '請輸入用戶名';
$_LANG['no_emaill'] = '請輸入電子郵箱';
$_LANG['no_code'] = '請輸入驗證碼';
$_LANG['code'] = '驗證碼';
$_LANG['no_password'] = '請輸入登錄密碼';
$_LANG['get_code'] = '獲取驗證碼';

/* 登錄 注冊 */
$_LANG['mobile_login'] = '手機注冊';
$_LANG['emaill_login'] = '郵箱注冊';

$_LANG['login'] = '登錄';
$_LANG['sms_code_error'] = '驗證碼不匹配';
$_LANG['mobile_code_error'] = '手機驗證碼錯誤';
$_LANG['register_back'] = '重新注冊';
$_LANG['msg_mobile_blank'] = '手機號不能爲空';
$_LANG['msg_mobile_exists'] = '手機號已存在';
$_LANG['next'] = '下壹步';
...
$_LANG['remember'] = '記住本次登錄。';
$_LANG['now_landing'] = '立即登陸';
$_LANG['free_registered'] = '免費注冊';
$_LANG['third_login'] = '使用合作賬號登錄';
$_LANG['no_register_auth'] = '還沒有注冊該插件，請與後台管理員聯系';
$_LANG['msg_un_blank'] = '用戶名不能爲空';
$_LANG['msg_mast_length'] = '用戶名必須爲3-15個字符';
...
$_LANG['username_not_allow'] = '用戶名 %s 不允許注冊';
$_LANG['confirm_register'] = '確認注冊';

$_LANG['agreement'] = "我已看過並接受《<a href=\"".url('article/info', array('aid'=>6))."\" style=\"color:blue\" target=\"_blank\">用戶協議</a>》";

$_LANG['email_empty'] = 'email爲空';
$_LANG['email_invalid'] = '%s 不是合法的email地址';
$_LANG['email_exist'] = '%s 已經存在';
$_LANG['email_not_allow'] = 'Email %s 不允許注冊';
$_LANG['register'] = '注冊';
$_LANG['register_success'] = '用戶名 %s 注冊成功';

$_LANG['passwd_question'] = '密碼提示問題';
$_LANG['sel_question'] = '請選擇密碼提示問題';
$_LANG['passwd_answer'] = '問題答案';
$_LANG['passwd_balnk'] = '密碼中不能包含空格';

/* 用戶中心默認頁面 */
$_LANG['user_center'] = '個人中心';
$_LANG['welcome_to'] = '歡迎您回到';
$_LANG['last_time'] = '您的上壹次登錄時間';
$_LANG['your_account'] = '您的賬戶';
$_LANG['your_notice'] = '用戶提醒';
$_LANG['your_surplus'] = '余額';
...
$_LANG['del_attention'] = '確認取消此商品的關注麽？';
$_LANG['add_to_attention'] = '確定將此商品加入關注列表麽？';
...
$_LANG['goods_num_must_over_0'] = '商品數量應該大于0';
$_LANG['rows_num_must_be_int'] = '排列顯示條目數應該是整數';
$_LANG['rows_num_must_over_0'] = '排列顯示條目數應該大于0';
...
/* 我的標簽 */
$_LANG['no_tag'] = '暫時沒有標簽';
$_LANG['confirm_drop_tag'] = '您確認要刪除此標簽嗎？';

/* user_passport.dwt js語言文件 */
$_LANG['passport_js']['username_empty'] = '- 用戶名不能爲空。';
$_LANG['passport_js']['username_shorter'] = '- 用戶名長度不能少于 3 個字符。';
$_LANG['passport_js']['username_longer'] = '- 用戶名長度不能超過15個字符。';
$_LANG['passport_js']['username_invalid'] = '- 用戶名只能是由字母數字以及下劃線組成。';
$_LANG['passport_js']['password_empty'] = '- 登錄密碼不能爲空。';
$_LANG['passport_js']['password_shorter'] = '- 登錄密碼不能少于 6 個字符。';
$_LANG['passport_js']['confirm_password_invalid'] = '- 兩次輸入密碼不壹致';
$_LANG['passport_js']['email_empty'] = '- Email 爲空';
$_LANG['passport_js']['email_invalid'] = '- Email 不是合法的地址';
$_LANG['passport_js']['agreement'] = '- 您沒有接受協議';
$_LANG['passport_js']['msn_invalid'] = '- msn地址不是壹個有效的郵件地址';
$_LANG['passport_js']['qq_invalid'] = '- QQ號碼不是壹個有效的號碼';
$_LANG['passport_js']['home_phone_invalid'] = '- 家庭電話不是壹個有效號碼';
$_LANG['passport_js']['office_phone_invalid'] = '- 辦公電話不是壹個有效號碼';
$_LANG['passport_js']['mobile_phone_invalid'] = '- 手機號碼不是壹個有效號碼';
...
/* 合並訂單js */
$_LANG['merge_order_js']['from_order_empty'] = '請選擇要合並的從訂單';
$_LANG['merge_order_js']['to_order_empty'] = '請選擇要合並的主訂單';
$_LANG['merge_order_js']['order_same'] = '主訂單和從訂單相同，請重新選擇';
$_LANG['merge_order_js']['confirm_merge'] = '您確實要合並這兩個訂單嗎？';
...
$_LANG['affiliate_type'][0] = '推薦注冊分成';
$_LANG['affiliate_type'][1] = '推薦訂單分成';
$_LANG['affiliate_type'][-1] = '推薦注冊分成';
$_LANG['affiliate_type'][-2] = '推薦訂單分成';

$_LANG['affiliate_codetype'] = '格式';

$_LANG['affiliate_introduction'] = '分成模式介紹';
$_LANG['affiliate_intro'][0] = '　　本網店爲鼓勵推薦新用戶注冊，現開展<b>推薦注冊分成</b>活動，活動流程如下：

　　１、將本站提供給您的推薦代碼，發送到論壇、博客上。
　　２、訪問者點擊鏈接，訪問網店。
　　３、在訪問者點擊鏈接的 <b>%d%s</b> 內，若該訪問者在本站注冊，即認定該用戶是您推薦的，您將獲得等級積分 <b>%d</b> 的獎勵 (當您的等級積分超過 <b>%d</b> 時，不再獲得獎勵)。
　　４、該用戶今後在本站的壹切消費，您均能獲得壹定比例的提成。目前實行的提成總額爲訂單金額的 <b>%s</b> 、積分的 <b>%s</b> ，分配給您、推薦您的人等，具體分配規則請參閱 <b><a href="#myrecommend">我推薦的會員</a></b>。
　　５、提成由管理員人工審核發放，請您耐心等待。
　　６、您可以通過分成明細來查看您的介紹、分成情況。';
$_LANG['affiliate_intro'][1] = '　　本網店爲鼓勵推薦新用戶注冊，現開展<b>推薦訂單分成</b>活動，活動流程如下：

　　１、在浏覽商品時，點擊推薦此商品，獲得推薦代碼，將其發送到論壇、博客上。
　　２、訪問者點擊鏈接，訪問網店。
...
$_LANG['level_register_all'] = '注冊積分分成數';
...
$_LANG['register_affiliate'] = '推薦會員ID %s ( %s ) 注冊送積分';
$_LANG['register_points'] = '注冊送積分';

$_LANG['validate_ok'] = '%s 您好，您email %s 已通過驗證';
$_LANG['validate_fail'] = '驗證失敗，請確認妳的驗證鏈接是否正確';
...
$_LANG['im_code'] = '聊天分享';
$_LANG['code_copy'] = '複制代碼';
$_LANG['show_good_to_you'] = '推薦給妳壹個好東西';


/* 積分兌換 */
$_LANG['transform_points'] = '積分兌換';
$_LANG['invalid_points'] = '妳輸入的積分是不壹個合法值';
$_LANG['invalid_input'] = '無效';
$_LANG['overflow_points'] = '您輸入的兌換積分超過您的實際積分';
$_LANG['to_pay_points'] = '恭喜您， 妳%s論壇%s兌換了%s的商城消費積分';
$_LANG['to_rank_points'] = '恭喜您， 妳%s論壇%s兌換了%s的商城等級積分';
$_LANG['from_pay_points'] = '恭喜您， 妳%s的商城消費積分兌換%s論壇%s';
$_LANG['from_rank_points'] = '恭喜您， 妳%s論壇%s兌換了%s的商城消費積分';
...
$_LANG['exchange_js']['balance'] = '您的{%s}余額不足，請重新輸入';
$_LANG['exchange_deny'] = '該積分不允許兌換';
$_LANG['exchange_success'] = '恭喜您， 妳用%s個%s兌換了%s個%s';
...
$_LANG['pwd_middle'] = '中';
$_LANG['pwd_high'] = '強';
$_LANG['user_reg_info'][0] = '如果您不是會員，請注冊';
$_LANG['user_reg_info'][1] = '友情提示';
$_LANG['user_reg_info'][2] = '不注冊爲會員也可在本店購買商品';
$_LANG['user_reg_info'][8] = '不注冊爲會員不可以在本店購買商品';
$_LANG['user_reg_info'][3] = '但注冊之後您可以';
