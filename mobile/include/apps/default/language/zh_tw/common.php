...
$_LANG['shop_register_closed'] = '該網店暫停注冊';
...
$_LANG['article_detail'] = '問題詳情';
$_LANG['piece'] = '件';

$_LANG['goods_category'] = "商品分類";
$_LANG['menu'] = "菜單";
$_LANG['goods_detail'] = "商品詳情";
$_LANG['detail_intro'] = "詳細介紹";
$_LANG['order_detail'] = "訂單確認";
$_LANG['order_submit'] = "訂單提交";
$_LANG['select_shipping_method'] = "請選擇配送方式";
$_LANG['select_payment_method'] = "請選擇支付方式";
$_LANG['check_out'] = "立即結算";
$_LANG['show_favourable'] = "查看優惠活動";
$_LANG['empty_shopping'] = "購物車什麽都沒有，趕快去購物吧";
$_LANG['go_shopping'] = "去購物";
$_LANG['shopping_cart'] = "購物車";
$_LANG['total_number'] = "件商品";
$_LANG['goods_price'] = "總價(不含運費)";
$_LANG['favourable_mz'] = "贈";
$_LANG['favourable_mj'] = "減";
$_LANG['favourable_zk'] = "折";
$_LANG['group_buy_act'] = "團";
$_LANG['snatch_act'] = "奪";
$_LANG['auction_act'] = "拍賣";

/* 分類展示頁  */
$_LANG['sort_default'] = '默認';
$_LANG['sort_sales'] = '銷量';
$_LANG['sort_popularity'] = '人氣';
$_LANG['sort_price'] = '價格';
$_LANG['like_num'] = '人喜歡';
$_LANG['scan_num'] = '次浏覽';
...
$_LANG['login_please'] = '由于您還沒有登錄，因此您還不能使用該功能。';
$_LANG['collect_existed'] = '該商品已經存在于您的收藏夾中。';
...
$_LANG['tag_exists'] = '您已經爲該商品添加過壹個標記，請不要重複提交.';
$_LANG['tag_cloud'] = '標簽雲';
$_LANG['tag_anonymous'] = '對不起，只有注冊會員並且正常登錄以後才能提交標記。';
$_LANG['tag_cloud_desc'] = '標簽雲（Tag cloud）是用以表示壹個網站中的內容標簽。 標簽（tag、關鍵詞）是壹種更爲靈活、有趣的商品分類方式，您可以爲每個商品添加壹個或多個標簽，那麽可以通過點擊這個標簽查看商品其他會員提交的與您的標簽壹樣的商品,能夠讓您使用最快的方式查找某壹個標簽的所有網店商品。比方說點擊“紅色”這個標簽，就可以打開這樣的壹個頁面，顯示所有的以“紅色” 爲標簽的網店商品';

/* AJAX 相關 */
$_LANG['invalid_captcha'] = '對不起，您輸入的驗證碼不正確。';
$_LANG['goods_exists'] = '對不起，您的購物車中已經存在相同的商品。';
$_LANG['fitting_goods_exists'] = '對不起，您的購物車中已經添加了該配件。';
$_LANG['invalid_number'] = '對不起，您輸入了壹個非法的商品數量。';
...
$_LANG['art_no_keywords'] = "輸入問題關鍵字搜索！";
/* 分頁排序 */
...
$_LANG['reply_comment'] = '回複';
$_LANG['comment_captcha'] = '驗證碼';
$_LANG['comment_login'] = '只有注冊會員才能發表評論，請您登錄後再發表評論';
$_LANG['comment_custom'] = '評論失敗。只有在本店購買過商品的注冊會員才能發表評論。';
$_LANG['comment_brought'] = '評論失敗。只有購買過此商品的注冊用戶才能評論該商品。';
$_LANG['anonymous'] = '匿名用戶';

$_LANG['five_stars'] = '非常好';
$_LANG['four_stars'] = '很好';
$_LANG['three_stars'] = '壹般';
$_LANG['two_stars'] = '不行';
$_LANG['one_stars'] = '很差';

$_LANG['all_comment'] = '全部';
$_LANG['favorable_comment'] = '好評';
$_LANG['medium_comment'] = '中評';
$_LANG['bad_comment'] = '差評';
/* 其他信息 */
$_LANG['js_languages']['goodsname_not_null'] = '商品名不能爲空！';

/* 商品比較 */
$_LANG['compare_remove'] = '移除';
$_LANG['compare_no_goods'] = '您沒有選定任何需要比較的商品或者比較的商品數少于 2 個。';
...
$_LANG['not_in_range'] = '妳只能在%d到%d之間出價';
$_LANG['also_bid'] = '妳已經出過價格 %s 了';
$_LANG['lack_pay_points'] = '妳積分不夠，不能出價';
$_LANG['snatch'] = '奪寶奇兵';
...
$_LANG['snatch_victory_desc'] = '當本期活動截止時，系統將從所有競價獎品的用戶中，選出在所有競價中出價最低、且沒有其他出價與該價格重複的用戶（即最低且唯壹競價），成爲該款獎品的獲勝者.';
$_LANG['price_less_victory'] = '如果用戶獲勝的價格低于';
$_LANG['price_than_victory'] = '將能按當期競拍價購得該款獎品；如果用戶獲勝的價格高于';
$_LANG['or_can'] = '則能以';
...
$_LANG['use_surplus'] = '余額付款';
$_LANG['your_surplus'] = '您當前的可用余額爲';
$_LANG['pay_fee'] = '支付手續費';
...
$_LANG['receive'] = '收貨確認';
$_LANG['buyer'] = '買家';
$_LANG['next_article'] = '下壹篇';
$_LANG['prev_article'] = '上壹篇';

/* 虛擬商品 */
$_LANG['virtual_goods_ship_fail'] = '自動發貨失敗，請盡快聯系商家重新發貨';
...
$_LANG['order_not_exists'] = "非常抱歉，沒有找到指定的訂單。請和網站管理員聯系。";
...
$_LANG['gb_notice_login'] = '提示：您需要先注冊成爲本站會員並且登錄後，才能參加商品團購!';
...
$_LANG['au_bid_after_login'] = '您只有注冊成爲會員並且登錄之後才能出價';
$_LANG['au_bid_repeat_user'] = '您已經是這個商品的最高出價人了';
$_LANG['au_your_lowest_price'] = '您的出價不能低于 %s';
...
$_LANG['ws_remark'] = '請輸入您的聯系方式、付款方式和配送方式等信息';
$_LANG['ws_order_submitted'] = '您的訂單已提交成功，請記住您的訂單號: %s。';
$_LANG['ws_price_list'] = '價格單';

/* 積分兌換部分語言項 */
$_LANG['exchange'] = '積分商城';
$_LANG['exchange_num'] = '兌換量';
$_LANG['exchange_integral'] = '積分';
...
$_LANG['brand_category'] = '分類浏覽：';
$_LANG['all_category'] = '所有分類';

/* 商品分類頁 */
$_LANG['goods_filter'] = '篩選';
...
$_LANG['sendemail_false'] = "郵件發送失敗，請與網站管理員聯系！";
...
$_LANG['email_alreadyin_list'] = '郵件地址已經存在于列表中！';
...
$_LANG['please_select_attr'] = '妳加入購物車的商品有不同型號可選，妳是否要立即跳轉到商品詳情選擇型號？';
...
$_LANG['view_history'] = '浏覽曆史';
$_LANG['clear_history'] = '[清空]';
$_LANG['no_history'] = '您已清空最近浏覽過的商品';
$_LANG['goods_tag'] = '商品標簽';
...
$_LANG['log_action']['tag_manage'] = '標簽管理';
$_LANG['log_action']['shop_config'] = '商店設置';
$_LANG['log_action']['languages'] = '前台語言項';
$_LANG['log_action']['user_surplus'] = '會員余額';
...
$_LANG['log_action']['reg_fields'] = '會員注冊項';

/*------------------------------------------------------ */
//-- 購物流程
/*------------------------------------------------------ */
$_LANG['flow_login_register']['username_not_null'] = '請您輸入用戶名。';
$_LANG['flow_login_register']['username_invalid'] = '您輸入了壹個無效的用戶名。';
...
$_LANG['flow_login_register']['password_not_same'] = '您輸入的密碼和確認密碼不壹致。';
$_LANG['flow_login_register']['password_lt_six'] = '密碼不能小于6個字符。';

$_LANG['regist_success'] = "恭喜您，%s 賬號注冊成功!";
...
$_LANG['package_stock_insufficiency'] = '非常抱歉，您選擇的超值禮包數量已經超出庫存。請您減少購買量或聯系商家。';
$_LANG['shopping_flow'] = '購物流程';
$_LANG['username_exists'] = '您輸入的用戶名已存在，請換壹個試試。';
$_LANG['email_exists'] = '您輸入的電子郵件已存在，請換壹個試試。';
$_LANG['surplus_not_enough'] = '您使用的余額不能超過您現有的余額。';
...
$_LANG['pay_success'] = '本次支付已經成功，我們將盡快爲您發貨。';
$_LANG['pay_fail'] = '本次支付失敗，請及時和我們取得聯系。';
$_LANG['pay_disabled'] = '您選用的支付方式已經被停用。';
$_LANG['pay_invalid'] = '您選用了壹個無效的支付方式。該支付方式不存在或者已經被停用。請您立即和我們取得聯系。';
$_LANG['flow_no_shipping'] = '您必須選定壹個配送方式。';
$_LANG['flow_no_payment'] = '您必須選定壹個支付方式。';
...
$_LANG['your_discount'] = '根據優惠活動<a href="'.url('activity/index').'"><font color=red>%s</font></a>，您可以享受折扣 %s';
$_LANG['no'] = '無';
...
$_LANG['forthwith_register'] = '注冊新用戶';
$_LANG['signin_failed'] = '對不起，登錄失敗，請檢查您的用戶名和密碼是否正確';
$_LANG['gift_remainder'] = '說明：在您登錄或注冊後，請到購物車頁面重新選擇贈品。';

/* 收貨人信息 */
$_LANG['flow_js']['consignee_not_null'] = '收貨人姓名不能爲空！';
...
$_LANG['flow_js']['invalid_email'] = '您輸入的郵件地址不是壹個合法的郵件地址。';
$_LANG['flow_js']['address_not_null'] = '收貨人的詳細地址不能爲空！';
$_LANG['flow_js']['tele_not_null'] = '電話不能爲空！';
...
$_LANG['flow_js']['mobile_not_null'] = '手機號碼不能爲空';
...
$_LANG['balance_not_enough'] = '您的余額不足以支付整個訂單，請選擇其他支付方式';
$_LANG['select_shipping'] = '您選定的配送方式爲';
$_LANG['select_payment'] = '您選定的支付方式爲';
$_LANG['change_payment'] = '或更換支付方式';
$_LANG['order_amount'] = '您的應付款金額爲';
$_LANG['remember_order_number'] = '感謝您在本店購物！您的訂單已提交成功，請記住您的訂單號';
$_LANG['back_home'] = '<a href="'.url('index/index').'">返回首頁</a>';
$_LANG['goto_user_center'] = '<a href="'.url('user/index').'">用戶中心</a>';
