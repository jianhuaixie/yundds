...
$_LANG['cat_image'] = '分類小圖標';
$_LANG['cat_style'] = '分類的樣式表文件';
$_LANG['is_show'] = '是否顯示';
$_LANG['show_in_index'] = '設置爲首頁推薦';
...
$_LANG['notice_style'] = '您可以爲每壹個商品分類指定壹個樣式表文件。例如文件存放在 themes 目錄下則輸入：themes/style.css';

/* 操作提示信息 */
$_LANG['catname_empty'] = '分類名稱不能爲空!';
$_LANG['catname_exist'] = '已存在相同的分類名稱!';
$_LANG["parent_isleaf"] = '所選分類不能是末級分類!';
$_LANG["cat_isleaf"] = '不是末級分類或者此分類下還存在有商品,您不能刪除!';
$_LANG["cat_noleaf"] = '底下還有其它子分類,不能修改爲末級分類!';
...
$_LANG['cat_move_notic'] = '在添加商品或者在商品管理中,如果需要對商品的分類進行變更,那麽妳可以通過此功能,正確管理妳的商品分類。';

$_LANG['cat_move_empty'] = '妳沒有正確選擇商品分類!';

$_LANG['sel_goods_type'] = '請選擇商品類型';
$_LANG['sel_filter_attr'] = '請選擇篩選屬性';
$_LANG['filter_attr'] = '篩選屬性';
$_LANG['filter_attr_notic'] = '篩選屬性可在前分類頁面篩選商品';
$_LANG['filter_attr_not_repeated'] = '篩選屬性不可重複';

/* JS 語言項 */
$_LANG['js_languages']['catname_empty'] = '分類名稱不能爲空!';
$_LANG['js_languages']['unit_empyt'] = '數量單位不能爲空!';
$_LANG['js_languages']['is_leafcat'] = '您選定的分類是壹個末級分類。\r\n新分類的上級分類不能是壹個末級分類';
$_LANG['js_languages']['not_leafcat'] = '您選定的分類不是壹個末級分類。\r\n商品的分類轉移只能在末級分類之間才可以操作。';
