...
$_LANG['cp_home'] = '管理中心';
$_LANG['copyright'] = '上海商創網絡科技有限公司. All Rights Reserved.';
$_LANG['query_info'] = '共執行 %d 個查詢，用時 %s 秒';
$_LANG['memory_info'] = '，內存占用 %0.3f MB';
...
$_LANG['auto_redirection'] = '如果您不做出選擇，將在 <span id="spanSeconds">3</span> 秒後跳轉到第壹個鏈接地址。';
...
$_LANG['confirm_uninstall'] = '您確定要卸載嗎？';
$_LANG['disabled'] = '禁用';
$_LANG['enabled'] = '啓用';
$_LANG['setup'] = '設置';
$_LANG['success'] = '成功';
...
$_LANG['drop_confirm'] = '您確定要刪除該公衆號嗎？\n刪除後無法恢複。';
...
$_LANG['09_authorization_list'] = '授權登錄';
