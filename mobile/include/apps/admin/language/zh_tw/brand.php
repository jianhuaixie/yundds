...
/* 幫助信息 */
$_LANG['up_brandlogo'] = '請上傳圖片，做爲品牌的LOGO！';
$_LANG['warn_brandlogo'] = '妳已經上傳過圖片。再次上傳時將覆蓋原圖片！';
...
$_LANG['js_languages']['require_num'] = '排序序號必須是壹個數字';
?>
