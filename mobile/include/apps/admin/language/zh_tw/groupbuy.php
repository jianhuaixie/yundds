...
$_LANG['label_goods_banner'] = '團購banner：';
...
$_LANG['notice_finish'] = '（修改活動結束時間爲當前時間）';
...
$_LANG['notice_mail'] = '（通知客戶付清余款，以便發貨）';
$_LANG['mail_result'] = '該團購活動共有 %s 個有效訂單，成功發送了 %s 封郵件。';
$_LANG['invalid_time'] = '您輸入了壹個無效的團購時間。';
...
$_LANG['error_goods_exist'] = '您選擇的商品目前有壹個團購活動正在進行！';
$_LANG['error_price_ladder'] = '您沒有輸入有效的價格階梯！';
$_LANG['error_restrict_amount'] = '限購數量不能小于價格階梯中的最大數量';
