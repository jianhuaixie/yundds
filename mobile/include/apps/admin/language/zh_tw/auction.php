...
$_LANG['label_goods_banner'] = '拍賣banner：';
$_LANG['notice_act_name'] = '如果留空，取拍賣商品的名稱（該名稱僅用于後台，前台不會顯示）';
...
$_LANG['js_languages']['end_price_not_number'] = '壹口價格式不正確（數字）';
$_LANG['js_languages']['end_gt_start'] = '壹口價應該大于起拍價';
$_LANG['js_languages']['amplitude_not_number'] = '加價幅度格式不正確（數字）';
$_LANG['js_languages']['deposit_not_number'] = '保證金格式不正確（數字）';
$_LANG['js_languages']['start_lt_end'] = '拍賣開始時間不能大于結束時間';
