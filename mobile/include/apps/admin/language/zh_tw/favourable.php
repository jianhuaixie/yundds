...
$_LANG['notice_act_type'] = '當優惠方式爲“享受贈品（特惠品）”時，請輸入允許買家選擇贈品（特惠品）的最大數量，數量爲0表示不限數量；' .
        '當優惠方式爲“享受現金減免”時，請輸入現金減免的金額；' .
        '當優惠方式爲“享受價格折扣”時，請輸入折扣（1－99），如：打9折，就輸入90。';
...
$_LANG['js_languages']['amount_invalid'] = '金額上限小于金額下限。';
$_LANG['js_languages']['start_lt_end'] = '優惠開始時間不能大于結束時間';

/* post */
$_LANG['pls_set_user_rank'] = '請設置享受優惠的會員等級';
$_LANG['pls_set_act_range'] = '請設置優惠範圍';
$_LANG['amount_error'] = '金額下限不能大于金額上限';
$_LANG['act_name_exists'] = '該優惠活動名稱已存在，請您換壹個';
