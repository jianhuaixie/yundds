...
$_LANG['publish_to_player'] = '發布到Flash播放列表';
$_LANG['publish_to_ads'] = '發布到廣告';

/* 提示信息 */
$_LANG['succed'] = '操作成功!';
$_LANG['notice_template_file'] = '選擇當前專題的模板文件名,模板文件應上傳到當前商城模板目錄下,自定義模版名稱以topc_開頭。';
...
$_LANG['js_languages']['start_lt_end'] = '專題開始時間不能大于結束時間';
$_LANG['invalid_type'] = '您上傳的圖片格式不正確！';
$_LANG['web_url_no'] = '遠程地址錯誤。請填寫完整的 URL 地址！';

$_LANG['topic_name_empty'] = '請輸入專題名稱!';
$_LANG['start_time_empty'] = '請選擇專題開始時間!';
$_LANG['end_time_empty'] = '請選擇專題結束時間!';
...
$_LANG['tips_width_height'] = '此模板的圖片標准寬度爲：%s 標准高度爲：%s';
$_LANG['tips_upload_notice'] = '上傳該廣告的圖片文件,或者妳也可以指定壹個遠程URL地址爲廣告的圖片';
$_LANG['tips_title_width_height'] = '此模板的圖片標准寬度爲：%s 標准高度爲：%s';
