...
$_LANG['cfg_name']['use_storage'] = '是否啓用庫存管理';
...
$_LANG['cfg_name']['enable_order_check'] = '是否開啓新訂單提醒';
...
$_LANG['cfg_name']['history_number'] = '浏覽曆史數量';
...
$_LANG['cfg_name']['order_pay_note'] = '設置訂單爲“已付款”時';
$_LANG['cfg_name']['order_unpay_note'] = '設置訂單爲“未付款”時';
$_LANG['cfg_name']['order_ship_note'] = '設置訂單爲“已發貨”時';
$_LANG['cfg_name']['order_unship_note'] = '設置訂單爲“未發貨”時';
$_LANG['cfg_name']['when_dec_storage'] = '什麽時候減少庫存';
$_LANG['cfg_name']['send_ship_email'] = '發貨時';
$_LANG['cfg_name']['order_receive_note'] = '設置訂單爲“收貨確認”時';
$_LANG['cfg_name']['order_cancel_note'] = '取消訂單時';
$_LANG['cfg_name']['send_cancel_email'] = '取消訂單時';
$_LANG['cfg_name']['order_return_note'] = '退貨時';
$_LANG['cfg_name']['order_invalid_note'] = '把訂單設爲無效時';
$_LANG['cfg_name']['send_invalid_email'] = '把訂單設爲無效時';
...
$_LANG['cfg_name']['show_asynclist'] = '列表分頁類型';
...
$_LANG['cfg_name']['show_goods_in_cart'] = '購物車裏顯示商品方式';
$_LANG['cfg_name']['show_attr_in_cart'] = '購物車裏是否顯示商品屬性';
$_LANG['test_mail_title'] = '測試郵件';
$_LANG['cfg_name']['email_content'] = '您好！這是壹封檢測郵件服務器設置的測試郵件。收到此郵件，意味著您的郵件服務器設置正確！您可以進行其它郵件發送的操作了！';
...
$_LANG['cfg_name']['cron_method'] = '是否開啓命令行調用計劃任務';
...
$_LANG['cfg_name']['name_of_region_1'] = '壹級配送區域名稱';
...
$_LANG['cfg_desc']['rewrite'] = 'URL重寫是壹種搜索引擎優化技術，可以將動態的地址模擬成靜態的HTML文件。需要Apache的支持。';
...
$_LANG['cfg_desc']['shop_title'] = '商店的標題將顯示在浏覽器的標題欄';
$_LANG['cfg_desc']['smtp_host'] = '郵件服務器主機地址。如果本機可以發送郵件則設置爲localhost';
$_LANG['cfg_desc']['smtp_user'] = '發送郵件所需的認證帳號，如果沒有就爲空著';
$_LANG['cfg_desc']['bought_goods'] = '顯示多少個購買此商品的人還買過哪些商品';
$_LANG['cfg_desc']['currency_format'] = '顯示商品價格的格式，%s將被替換爲相應的價格數字。';
$_LANG['cfg_desc']['image_height'] = '如果您的服務器支持GD，在您上傳商品圖片的時候將自動將圖片縮小到指定的尺寸。';
$_LANG['cfg_desc']['watermark'] = '水印文件須爲gif格式才可支持透明度設置。';
$_LANG['cfg_desc']['watermark_alpha'] = '水印的透明度，可選值爲0-100。當設置爲100時則爲不透明。';
$_LANG['cfg_desc']['invoice_content'] = '客戶要求開發票時可以選擇的內容。例如：辦公用品。每壹行代表壹個選項。';
$_LANG['cfg_desc']['stats_code'] = '您可以將其他訪問統計服務商提供的代碼添加到每壹個頁面。';
$_LANG['cfg_desc']['cache_time'] = '前台頁面緩存的存活時間，以秒爲單位。';
...
$_LANG['cfg_desc']['shop_logo'] = '請在上傳前將圖片的文件名命名爲logo.gif';
$_LANG['cfg_desc']['enable_gzip'] = '啓用Gzip模式可壓縮發送頁面大小，加快網頁傳輸。需要php支持Gzip。如果已經用Apache等對頁面進行Gzip壓縮，請禁止該功能。';
$_LANG['cfg_desc']['skype'] = '如果您有多個客服的Skype號碼，請在每個號碼之間使用半角逗號（,）分隔。提示：妳需要在妳的Skype隱私設置中啓用狀態顯示功能';
$_LANG['cfg_desc']['attr_related_number'] = '在商品詳情頁面顯示多少個屬性關聯的商品。';
$_LANG['cfg_desc']['user_notice'] = '該信息將在用戶中心歡迎頁面顯示';
$_LANG['cfg_desc']['comment_factor'] = '選取較高的評論條件可以有效的減少垃圾評論的産生。只有用戶訂單完成後才認爲該用戶有購買行爲';
...
$_LANG['cfg_desc']['bgcolor'] = '顔色請以#FFFFFF格式填寫';
$_LANG['cfg_desc']['cart_confirm'] = '允許您設置用戶點擊“加入購物車”後是否提示以及隨後的動作。';
$_LANG['cfg_desc']['use_how_oos'] = '使用缺貨處理時前台訂單確認頁面允許用戶選擇缺貨時處理方法。';
$_LANG['cfg_desc']['send_service_email'] = '網店信息中的客服郵件地址不爲空時，該選項有效。';
$_LANG['cfg_desc']['send_mail_on'] = '啓用該選項登錄後台時，會自動發送郵件隊列中尚未發送的郵件';
$_LANG['cfg_desc']['sms_shop_mobile'] = '請先注冊手機短信服務再填寫手機號碼 <a href="http://www.ecmoban.com/goods-475.html" target="_blank">點此注冊手機短信服務</a>';
$_LANG['cfg_desc']['send_verify_email'] = '“是否開啓會員郵件驗證”設爲開啓時才可使用此功能';
...
$_LANG['cfg_range']['send_mail_on']['on'] = '開啓';
$_LANG['cfg_range']['send_mail_on']['off'] = '關閉';
$_LANG['cfg_range']['member_email_validate']['1'] = '開啓';
$_LANG['cfg_range']['member_email_validate']['0'] = '關閉';
$_LANG['cfg_range']['send_verify_email']['1'] = '開啓';
$_LANG['cfg_range']['send_verify_email']['0'] = '關閉';
$_LANG['cfg_range']['message_board']['1'] = '開啓';
...
$_LANG['cfg_range']['top10_time']['1'] = '壹年';
$_LANG['cfg_range']['top10_time']['2'] = '半年';
$_LANG['cfg_range']['top10_time']['3'] = '三個月';
$_LANG['cfg_range']['top10_time']['4'] = '壹個月';
...
$_LANG['cfg_range']['comment_factor']['2'] = '有過壹次以上購買行爲用戶';
$_LANG['cfg_range']['comment_factor']['3'] = '僅購買過該商品用戶';
$_LANG['cfg_range']['enable_gzip']['1'] = '啓用';
$_LANG['cfg_range']['enable_gzip']['0'] = '禁用';
$_LANG['cfg_range']['price_format']['0'] = '不處理';
$_LANG['cfg_range']['price_format']['1'] = '保留不爲 0 的尾數';
$_LANG['cfg_range']['price_format']['2'] = '不四舍五入，保留壹位小數';
$_LANG['cfg_range']['price_format']['3'] = '不四舍五入，不保留小數';
$_LANG['cfg_range']['price_format']['4'] = '先四舍五入，保留壹位小數';
$_LANG['cfg_range']['price_format']['5'] = '先四舍五入，不保留小數 ';
...
$_LANG['cfg_range']['show_asynclist'][1] = '異步';
...
$_LANG['cfg_range']['visit_stats']['on'] = '開啓';
$_LANG['cfg_range']['visit_stats']['off'] = '關閉';

$_LANG['rewrite_confirm_apache'] = "URL Rewrite 功能要求您的 Web Server 必須是 Apache，\\n並且起用了 rewrite 模塊。\\n同時請您確認是否已經將htaccess.txt文件重命名爲.htaccess。\\n如果服務器上還有其他的重寫規則請去掉注釋,請將RewriteBase行的注釋去掉,並將路徑設置爲服務器請求的絕對路徑";
$_LANG['rewrite_confirm_iis'] = "URL Rewrite 功能要求您的 Web Server 必須安裝IIS，\\n並且起用了 ISAPI Rewrite 模塊。\\n如果您使用的是ISAPI Rewrite商業版，請您確認是否已經將httpd.txt文件重命名爲httpd.ini。如果您使用的是ISAPI Rewrite免費版，請您確認是否已經將httpd.txt文件內的內容複制到ISAPI Rewrite安裝目錄中httpd.ini裏。";
$_LANG['gzip_confirm'] = "GZip 功能需要您的服務器支持 zlib 擴展庫。\\n如果您發現開啓Gzip後頁面出現亂碼，可能是您的服務器已經開啓了Gzip，您不需要在 ECSHOP 中再次開啓。";
$_LANG['retain_original_confirm'] = "如果您不保留商品原圖，在“圖片批量處理”的時候，\\n將不會重新生成不包含原圖的商品圖片。請慎重使用該功能！";
$_LANG['msg_invalid_file'] = '您上傳了壹個非法的文件類型。該文件名爲：%s';
...
$_LANG['cfg_desc']['mail_service'] = '如果您選擇了采用服務器內置的 Mail 服務，您不需要填寫下面的內容。';
$_LANG['cfg_range']['mail_service'][0] = '采用服務器內置的 Mail 服務';
$_LANG['cfg_range']['mail_service'][1] = '采用其他的 SMTP 服務';
...
$_LANG['cfg_name']['smtp_mail'] = '郵件回複地址';
...
$_LANG['mail_settings_note'] = '如果您的服務器支持 Mail 函數（具體信息請咨詢您的空間提供商）。我們建議您使用系統的 Mail 函數。<br />當您的服務器不支持 Mail 函數的時候您也可以選用 SMTP 作爲郵件服務器。';
...
$_LANG['js_languages']['reply_email_empty'] = '您沒有填寫郵件回複地址!';
$_LANG['js_languages']['test_email_empty'] = '您沒有填寫發送測試郵件的地址!';
$_LANG['js_languages']['email_address_same'] = '郵件回複地址與發送測試郵件的地址不能相同!';

$_LANG['cfg_name']['wap'] = 'WAP設置';
$_LANG['cfg_name']['wap_config'] = '是否使用WAP功能';
$_LANG['cfg_range']['wap_config'][0] = '關閉';
$_LANG['cfg_range']['wap_config'][1] = '開啓';
$_LANG['cfg_name']['wap_logo'] = 'WAP LOGO上傳';
$_LANG['cfg_desc']['wap_logo'] = '爲了更好地兼容各種手機類型，LOGO 最好爲png圖片';
...
$_LANG['cfg_name']['sms_signin'] = '客戶注冊時是否發送短信驗證碼';
$_LANG['cfg_range']['sms_signin']['1'] = '發短信';
$_LANG['cfg_range']['sms_signin']['0'] = '不發短信';
$_LANG['cfg_name']['sms_ecmoban_user'] = '短信接口用戶名';
$_LANG['cfg_name']['sms_ecmoban_password'] = '短信接口密碼';
?>
