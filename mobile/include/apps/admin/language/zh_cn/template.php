...
$_LANG['dwt_not_written'] = '模板文件 %s 没有修改权限，该模板文件将无法修改';
$_LANG['update_dwt_success'] = '模板内容已经更新成功。';
$_LANG['update_dwt_failed'] = '编辑模板内容失败。请检查 %s 目录是否可以写入。';
...
$_LANG['template_libs']['asynclist_index'] = '首页异步加载商品';
$_LANG['template_libs']['asynclist_info'] = '异步加载商品';
$_LANG['template_libs']['goods_list_topic'] = '专题列表商品';
$_LANG['template_libs']['goods_list_exchange'] = '积分商城列表商品';
$_LANG['template_libs']['goods_list_brand'] = '品牌列表商品';
