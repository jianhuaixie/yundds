...
$_LANG['cfg_name']['hbstart'] = '红包最小金额';

$_LANG['cfg_name']['hbend'] = '红包最大金额';

$_LANG['cfg_name']['openfhb'] = '关注送红包开关（微信规定红包不可在晚上0点到早上8点之间发）';

$_LANG['cfg_range']['openfhb'][0] = '关闭';

$_LANG['cfg_range']['openfhb'][1] = '开启';

$_LANG['cfg_name']['starttime'] = '红包开始时间';

$_LANG['cfg_name']['endtime'] = '红包结束时间';

$_LANG['cfg_name']['allhb'] = '红包总金额';
