 ...
 * File name：topic.php
 * ----------------------------------------------------------------------------
 * Function description：Brand list of goods
 * ----------------------------------------------------------------------------
...
$_LANG['topic_name_empty'] = 'Please enter a topic name!';
$_LANG['start_time_empty'] = 'Please choose the subject starting time!';
$_LANG['end_time_empty'] = 'Choose the end time of the topic!';

/* Subject information field */
$_LANG['topic_id'] = 'No.';
