 ...
 * ----------------------------------------------------------------------------
 * Function description：Control panel template manage language file
 * ----------------------------------------------------------------------------
...
$_LANG['dwt_not_written'] = 'Template file %s hasn\'t right to edit, so edit the template file has failed.';
$_LANG['update_dwt_success'] = 'Template file content has uploaded successfully。';
$_LANG['update_dwt_failed'] = 'Edit template content has failed. Please check %s directory whether can be read-in.';
...
$_LANG['template_libs']['asynclist_index'] = 'Home asynchronous load goods';
$_LANG['template_libs']['asynclist_info'] = 'Asynchronous load commodity';
$_LANG['template_libs']['goods_list_topic'] = 'Topic list commodity';
$_LANG['template_libs']['goods_list_exchange'] = 'Integrated mall list of goods';
$_LANG['template_libs']['goods_list_brand'] = 'Brand list of goods';
