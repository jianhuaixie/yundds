 ...
 * ----------------------------------------------------------------------------
 * File name：articlecat.php
 * ----------------------------------------------------------------------------
 * Function description：Article\'s Category management program language file
 * ----------------------------------------------------------------------------
...
$_LANG['show_in_touch'] = 'Display in touch';
...
$_LANG['drop_succeed'] = 'drop_succeed！';
