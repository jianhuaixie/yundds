 ...
 * ----------------------------------------------------------------------------
 * Function description：shop config language file
 * ----------------------------------------------------------------------------
...
$_LANG['cfg_name']['display'] = 'Display settings';
...
$_LANG['cfg_name']['shop_url'] = 'ecshop URL';
...
$_LANG['cfg_name']['show_asynclist'] = 'List paging type';
...
$_LANG['cfg_range']['show_asynclist'][0] = 'Synchronous';
$_LANG['cfg_range']['show_asynclist'][1] = 'Asynchronous';
...
$_LANG['cfg_name']['sms_signin'] = 'Whether the customer registration sent SMS verification code';
$_LANG['cfg_range']['sms_signin']['1'] = 'send sms';
$_LANG['cfg_range']['sms_signin']['0'] = 'Not send sms';
$_LANG['cfg_name']['sms_ecmoban_user'] = 'SMS interface user name';
$_LANG['cfg_name']['sms_ecmoban_password'] = 'SMS interface user password';
?>
