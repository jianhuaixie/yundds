...
<table id="list-table" class="table table-bordered table-striped table-hover">
  <tr class="active">
    ...
    <th class="text-center" >{$lang['payment_desc']}</th>
    <th class="text-center" width="8%">{$lang['version']}</th>
    <th class="text-center" width="10%">{$lang['payment_author']}</th>
    <th class="text-center" width="5%">{$lang['short_pay_fee']}</th>
    <th class="text-center" width="5%">{$lang['sort_order']}</th>
  ...
  <tr>
    ...
    <td class="text-center">{$vo['pay_order']}</td>
