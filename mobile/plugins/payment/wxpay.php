...
/*
                    if(method_exists('WechatController', 'do_oauth')){
						...
						// send_tx_msg("订单支付提醒","您的订单：".$out_trade_no[0]."已经支付成功了，我们会尽快安排发货！",$order_url,$postdata['openid']);
						 
                       send_wechat_message('pay_remind', '', $out_trade_no[0] . ' 订单已支付', $order_url, $out_trade_no[0], $postdata['openid']);
