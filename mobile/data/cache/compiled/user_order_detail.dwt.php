...
<?php if ($this->_var['order']['order_status_return'] != '4'): ?> 

	<div class="two-btn ect-padding-tb ect-padding-lr ect-margin-tb text-center"><?php echo $this->_var['order']['handler']; ?>

  		<?php if ($this->_var['order']['invoice_no']): ?><a class="btn btn-info ect-bg-colory" type="button" href="<?php echo url('order_tracking', array('order_id'=>$this->_var['order']['order_id']));?>"><?php echo $this->_var['lang']['order_tracking']; ?></a><?php endif; ?> 
...
<section class="order-detail-info ect-margin-tb" style="margin-bottom:0;">
  ...
  <ul>
    ...
    <li class="text-right">
      ...
      + 运费:<b class="ect-colory"><?php echo $this->_var['order']['formated_shipping_fee']; ?></b><br>
