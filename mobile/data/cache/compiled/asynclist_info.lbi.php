...
<dl>
  ...
  <dd><span class="pull-left"><strong><span><?php echo $this->_var['lang']['price']; ?>：</span><b class="ect-colory"><?php if ($this->_var['goods']['promote_price']): ?><?php echo $this->_var['goods']['promote_price']; ?><?php else: ?><?php echo $this->_var['goods']['shop_price']; ?><?php endif; ?></b></strong><small class="ect-margin-lr"><del><?php echo $this->_var['goods']['market_price']; ?></del></small></span><span class="ect-pro-price"> 
...
<li>
  ...
  <p><a href="<?php echo $this->_var['brand']['url']; ?><?php if ($_SESSION['user_id'] > 0): ?>&u=<?php echo $_SESSION['user_id']; ?><?php endif; ?>"><img src="<?php echo $this->_var['brand']['brand_banner']; ?>"></a><span><?php echo $this->_var['brand']['brand_name']; ?></span></p>
...
<a href="<?php echo $this->_var['brand_goods']['url']; ?><?php if ($_SESSION['user_id'] > 0): ?>&u=<?php echo $_SESSION['user_id']; ?><?php endif; ?>"><img src="<?php echo $this->_var['brand_goods']['goods_thumb']; ?>" alt="<?php echo $this->_var['brand_goods']['name']; ?>"></a>

<dl>

  <dt>

    <h4 class="title"><a href="<?php echo $this->_var['brand_goods']['url']; ?><?php if ($_SESSION['user_id'] > 0): ?>&u=<?php echo $_SESSION['user_id']; ?><?php endif; ?>"><?php echo $this->_var['brand_goods']['goods_name']; ?></a></h4>

  </dt>

  <dd><span class="pull-left"><strong><span><?php echo $this->_var['lang']['price']; ?>：</span><b class="ect-colory"><?php if ($this->_var['brand_goods']['promote_price']): ?><?php echo $this->_var['brand_goods']['promote_price']; ?><?php else: ?><?php echo $this->_var['brand_goods']['shop_price']; ?><?php endif; ?></b></strong><small class="ect-margin-lr"><del><?php echo $this->_var['brand_goods']['market_price']; ?></del></small></span><span class="ect-pro-price"> 
...
?> 
  ...
  <dd><!--<span class="pull-left <?php if ($this->_var['goods']['mysc'] != 0): ?>ect-colory<?php endif; ?>"><i class="fa <?php if ($this->_var['goods']['mysc'] != 0): ?>fa-heart<?php else: ?>fa-heart-o<?php endif; ?>"></i> <?php echo $this->_var['brand_goods']['sc']; ?><?php echo $this->_var['lang']['like_num']; ?></span><span class="pull-right"><?php echo $this->_var['lang']['sort_sales']; ?>：<?php echo $this->_var['brand_goods']['sales_count']; ?> <?php echo $this->_var['lang']['piece']; ?></span>--> <span class="pull-right" style="background:#F00;padding:0 3px;"><a href="<?php echo $this->_var['brand_goods']['url']; ?><?php if ($_SESSION['user_id'] > 0): ?>&u=<?php echo $_SESSION['user_id']; ?><?php endif; ?>" style="color:#FFF;">立即抢购</a></span></dd>
...
<dl>
  ...
  <dd><span class="pull-left"><strong><span><?php echo $this->_var['lang']['price']; ?>：</span><b class="ect-colory"><?php if ($this->_var['act_goods']['promote_price']): ?><?php echo $this->_var['act_goods']['promote_price']; ?><?php else: ?><?php echo $this->_var['act_goods']['shop_price']; ?><?php endif; ?></b></strong><small class="ect-margin-lr"><del><?php echo $this->_var['act_goods']['market_price']; ?></del></small></span> <span class="ect-pro-price"> 
...
<dl>
  ...
  <dd class="dd-price"><span class="pull-left"><strong><span><?php echo $this->_var['lang']['price']; ?>：</span><b class="ect-colory"><?php echo $this->_var['groupbuy']['cur_price']; ?></b></strong><small class="ect-margin-lr"><del><?php echo $this->_var['groupbuy']['market_price']; ?></del></small></span><span class="ect-pro-price"> <i class="label zk"><?php echo $this->_var['groupbuy']['spare_discount']; ?><?php echo $this->_var['lang']['favourable_zk']; ?></i> </span></dd>
...
<a href="<?php echo $this->_var['article']['url']; ?><?php if ($_SESSION['user_id'] > 0): ?>&u=<?php echo $_SESSION['user_id']; ?><?php endif; ?>"><?php echo $this->_var['id']; ?>、<?php echo $this->_var['article']['short_title']; ?></a>
