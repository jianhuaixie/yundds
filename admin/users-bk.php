...
function user_list()
{
    ...
    if ($result === false)
    {
        ...
        $sql = "SELECT u.user_id, u.parent_id, u.msn, u.user_name, u.email, u.is_validated, u.user_money, u.frozen_money, u.rank_points, u.pay_points, u.reg_time, wx.ect_uid, wx.uid, wx.nickname, wx.headimgurl ".//hzh
                " FROM " . $GLOBALS['ecs']->table('users') . "AS u LEFT JOIN "  . $GLOBALS['ecs']->table('wechat_user') . " AS wx on u.parent_id=wx.ect_uid " . $ex_where .
