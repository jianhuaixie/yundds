    ...
    if ($seller['id'])
    {
      ...
      if ($goods_exists > 0)
       ...
       /* 删除管理员、发货单关联、退货单关联和订单关联的供货商 */
        $table_array = array('admin_user', 'delivery_order', 

'back_order','seller_shopwindow','seller_shopslide','seller_shopinfo','seller_nav','seller_category','back_order','order_return'
