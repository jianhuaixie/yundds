...
function create_html_editor($input_name, $input_value = '')
{
    ...
    <textarea id=\"$input_name\" name=\"$input_name\" style='width:800px;height:300px;'>$input_value</textarea>
	<div style=text-align:center;width:800px;margin-top:10px;><input type=\"submit\" value=\"提交\" /></div><br/>
	<div style=color:#f00;width:800px;text-align:center;>编辑完成请务必点击提交按钮</div>
    ";
