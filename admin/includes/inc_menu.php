...
//入驻商管理 青蜂网络0769web.net  商家入驻 start
...
//入驻商管理 青蜂网络0769web.net  商家入驻 end
...
//by ECTouch Leah
$modules['04_aftermarket']['01_service_type']               = 'aftermarket_type.php?act=service_type';//by Leah
$modules['04_aftermarket']['11_back_cause']               = 'aftermarket_cause.php?act=back_cause_list'; //by Leah
$modules['04_aftermarket']['12_back_apply']               = 'aftermarket.php?act=aftermarket_list';//by Leah
...
$modules['15_rec']['affiliate_ck2']                  = 'affiliate_ck2.php?act=list';
$modules['15_rec']['11_user_yongjin']         = 'user_yongjin.php?act=list';//hzh
$modules['15_rec']['12_user_ceng']         = 'user_ceng.php?act=list';//hzh
