...
if ($_REQUEST['act'] == 'list' || $_REQUEST['act'] == 'trash')
{
	...
	/*青蜂网络0769web.net  商家入驻 判断管理员是否有审核商家商品的权限*/
	//管理员信息
...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    /* 处理商品数据 */
    $cost_price = !empty($_POST['cost_price']) ? $_POST['cost_price'] : 0;//hzh
	$shop_price = !empty($_POST['shop_price']) ? $_POST['shop_price'] : 0;
	$fencheng1 = !empty($_POST['fencheng1']) ? $_POST['fencheng1'] : 0;//hzh
	$fencheng2 = !empty($_POST['fencheng2']) ? $_POST['fencheng2'] : 0;//hzh
    ...
    $give_integral_rate = isset($_POST['give_integral_rate']) ? intval($_POST['give_integral_rate']) : '';//hzh
    ...
    if ($is_insert)
    {
        if ($code == '')
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    "cat_id, brand_id, cost_price, shop_price, fencheng1, fencheng2, market_price, is_promote, promote_price, " .//hzh
                    "promote_start_date, promote_end_date, goods_img, goods_thumb, original_img, keywords, goods_brief, " .
                    "seller_note, goods_weight, goods_number, warn_number, integral, integral_rate, give_integral, give_integral_rate, is_best, is_new, is_hot, " .//hzh
                ...
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                    "'$brand_id', '$cost_price', '$shop_price', '$fencheng1', '$fencheng2', '$market_price', '$is_promote','$promote_price', ".//hzh
                    "'$promote_start_date', '$promote_end_date', '$goods_img', '$goods_thumb', '$original_img', ".
                    "'$_POST[keywords]', '$_POST[goods_brief]', '$_POST[seller_note]', '$goods_weight', '$goods_number',".
                    " '$warn_number', '$_POST[integral]', '$_POST[integral_rate]', '$give_integral', '$give_integral_rate', '$is_best', '$is_new', '$is_hot', '$is_on_sale', '$is_alone_sale', $is_shipping, ".//hzh
        ...
        else
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    "cat_id, brand_id, cost_price, shop_price, fencheng1, fencheng2, market_price, is_promote, promote_price, " .//hzh
                    "promote_start_date, promote_end_date, goods_img, goods_thumb, original_img, keywords, goods_brief, " .
                    "seller_note, goods_weight, goods_number, warn_number, integral, integral_rate, give_integral, give_integral_rate, is_best, is_new, is_hot, is_real, " .//hzh
                    "is_on_sale, is_alone_sale, is_shipping, goods_desc, add_time, last_update, goods_type, extension_code, rank_integral)" .
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                    "'$brand_id', '$cost_price', '$shop_price', '$fencheng1', '$fencheng2', '$market_price', '$is_promote','$promote_price', ".//hzh
                    "'$promote_start_date', '$promote_end_date', '$goods_img', '$goods_thumb', '$original_img', ".
                    "'$_POST[keywords]', '$_POST[goods_brief]', '$_POST[seller_note]', '$goods_weight', '$goods_number',".
                    " '$warn_number', '$_POST[integral]', '$_POST[integral_rate]', '$give_integral', '$give_integral_rate', '$is_best', '$is_new', '$is_hot', 0, '$is_on_sale', '$is_alone_sale', $is_shipping, ".//hzh
    ...
    else
    {
        ...
        $sql = "UPDATE " . $ecs->table('goods') . " SET " .
                ...
                "cat_id = '$catgory_id', " .
                "brand_id = '$brand_id', " .
                "cost_price = '$cost_price', " .//hzh
				"shop_price = '$shop_price', " .
				"fencheng1 = '$fencheng1', " .//hzh
				"fencheng2 = '$fencheng2', " .//hzh
        ...
        $sql .= "keywords = '$_POST[keywords]', " .
                ...
                "integral_rate = '$_POST[integral_rate]', " .//hzh
				"integral = '$_POST[integral]', " .
                "give_integral_rate = '$give_integral_rate', " .//hzh
    ...
    if (isset($img))
    {
        ...
        $sql = "INSERT INTO " . $ecs->table('goods_gallery') . " (goods_id, img_url, img_desc, img_sort, thumb_url, img_original) " .//hzh
                "VALUES ('$goods_id', '$gallery_img', '', '', '$gallery_thumb', '$img')";//hzh
        $db->query($sql);
    }

    /* 处理相册图片 */
    handle_gallery_image($goods_id, $_FILES['img_url'], $_POST['img_desc'], $_POST['img_sort'], $_POST['img_file']);//hzh
    ...
    if (!$is_insert && isset($_POST['old_img_sort']))
    {
        ...
        {
            $sql = "UPDATE " . $ecs->table('goods_gallery') . " SET img_sort = '$img_sort' WHERE img_id = '$img_id' LIMIT 1";
            $db->query($sql);
        }
    }
