...
$modules['10_priv_admin']['seller_list']         = 'user_sellers.php?act=list';//wang 商家入驻，商家申请入驻的信息列表
...
$modules['11_system']['021_seller_fields']             = 'seller_fields.php?act=list';//wang 商家入驻 商家注册项设置
