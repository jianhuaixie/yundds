...
{
	//检查名称是否重复
    $sql = 'SELECT COUNT(*) FROM ' .$ecs->table('seller_shopwindow'). " WHERE win_name = '$_POST[winname]' and seller_id='$_SESSION[seller_id]'";
...
//	}
	...
	{	
		...
		$link[2]['text'] = '添加橱窗商品';
		$link[2]['href'] = 'seller_window.php?act=add_win_goods';
