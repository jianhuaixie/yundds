...
if ($_REQUEST['act'] == 'remove')
{
    ...
    $db->query("DELETE FROM " .$ecs->table('booking_goods'). " WHERE rec_id='$id' and seller_id='".$_SESSION['seller_id']."'");
...
if ($_REQUEST['act'] =='update')
{
    ...
    $sql = "UPDATE  ".$ecs->table('booking_goods').
            ...
            " WHERE rec_id='$_REQUEST[rec_id]' and seller_id='".$_SESSION['seller_id']."'";
    $db->query($sql);
    ...
    if (!empty($_POST['send_email_notice']) or isset($_POST['remail']))
    {
        ...
        $sql = 'SELECT bg.email, bg.link_man, bg.goods_id, g.goods_name ' .
               ...
               "WHERE bg.goods_id = g.goods_id AND bg.rec_id='$_REQUEST[rec_id]' and bg.seller_id='".$_SESSION['seller_id']."'";
...
function get_bookinglist()
{
    ...
    $sql = 'SELECT COUNT(*) FROM ' .$GLOBALS['ecs']->table('booking_goods'). ' AS bg, '.
            ...
            "WHERE bg.goods_id = g.goods_id and bg.seller_id='".$_SESSION['seller_id']."' $where";
...
function get_booking_info($id)
{
    ...
    $sql ="SELECT bg.rec_id, bg.user_id, IFNULL(u.user_name, '$_LANG[guest_user]') AS user_name, ".
            ...
            "WHERE bg.rec_id ='$id' and bg.seller_id='".$_SESSION['seller_id']."' ";
