...
define('CS_FINISHED',               102); // 已完成：已确认、已付款、已发货 //HZH 已收货
define('CS_SHIPPED',               103); // 已完成：已确认、已付款、已发货 hzh
...
//define('RF_APPLY_SUCCESS', 1); // 申请成功
//define('RF_APPLY_FALSE', 2); // 审核失败
...
/**服务类型**/
define('ST_RETURN_GOODS', 1); //退货退款  已付款 已发货
define('ST_REFUND', 2); //仅退款 已发货
define('ST_EXCHANGE', 3); //换货 已付款 已发货
define('ST_REPAIR', 4); //维修  已付款 已发货


/* 服务订单审核状态 by ECTouch Leah End */
