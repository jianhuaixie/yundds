    ...
    if ($log_id > 0)
    {
        ...
        if ($pay_log && $pay_log['is_paid'] == 0)
        {
            ...
            $sql = 'UPDATE ' . $GLOBALS['ecs']->table('pay_log') .
                    " SET is_paid = '1' WHERE log_id = '$log_id' or parent_log_id='$log_id'";//青蜂网络www.0769web.net 商家分单支付日志
            ...
            if ($pay_log['order_type'] == PAY_ORDER)
            {
                ...
                $sql = 'UPDATE ' . $GLOBALS['ecs']->table('order_info') .
                            " SET order_status = '" . OS_CONFIRMED . "', " .
                                ...
                                " order_amount = 0 ".
                       "WHERE order_id = '$order_id' or parent_order_id='$order_id'";//青蜂网络www.0769web.net 商家入驻分单付款
                $GLOBALS['db']->query($sql);
