...
$_LANG['cs'][CS_SHIPPED] = '已发货';//hzh
$_LANG['cs'][CS_FINISHED] = '收货确认';//hzh
...
$_LANG['order_splited_sms'] = '您的订单%s，%s正在%s';
...
$_LANG['postcom'][16]['name'] = 'FedEx';
$_LANG['postcom'][17]['name'] = 'UPS';
$_LANG['postcom'][18]['name'] = 'DHL';
?>