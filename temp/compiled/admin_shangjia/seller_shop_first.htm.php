...
?>
    ...
    <?php if ($this->_var['store_two_code']): ?>
    <tr>
        <td class="micro-label">商店二维码Logo: </td>
        <td>
             <input type="file" name="two_code_logo"/>
             <?php if ($this->_var['shop_info']['two_code_logo']): ?>
             <img src="<?php echo $this->_var['shop_info']['two_code_logo']; ?>" width="150" />
             <?php endif; ?>   
                     
        </td>
    </tr>
     <tr>
      <td class="micro-label">店铺二维码:</td>
      <td><input type="radio" name="two_code" value="1" <?php if ($this->_var['shop_info']['two_code']): ?>checked="true"<?php endif; ?>/>开启&nbsp;&nbsp;<input type="radio" name="two_code" value="0" <?php if ($this->_var['shop_info']['two_code'] == 0): ?>checked="true"<?php endif; ?>/>关闭
      </td>
    </tr>
    <?php endif; ?>
    <tr>
