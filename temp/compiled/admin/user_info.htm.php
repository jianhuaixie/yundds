...
<table width="100%" >
  ...
  <!-- 新增绑定上级ID hzh-->
    ...
    <td><input name="parent_id" type="text" id="credit_line" value="<?php echo $this->_var['user']['parent_id']; ?>" size="10" /> 会员ID查看方法：点击会员列表，最前面编号就是对应的ID</td>
        ...
        <tr>
    <td class="label"><font style="color:red">自定义分销等级:</font></td>
<!--    <td><input name="fenxiao_rank" type="text" id="credit_line" value="<?php echo $this->_var['user']['fenxiao_rank']; ?>" size="10" /> 1为银1,2为银2,3为金1，4为金2，5为金3,6为金4</td>-->
<td>
<select name="fenxiao_rank">
<option value="1" <?php if ($this->_var['user']['fenxiao_rank'] == 1): ?> selected="selected"<?php endif; ?>><?php echo $this->_var['user']['fenxiao_rank_name']['0']; ?></option>
<option value="2" <?php if ($this->_var['user']['fenxiao_rank'] == 2): ?> selected="selected"<?php endif; ?>><?php echo $this->_var['user']['fenxiao_rank_name']['1']; ?></option>
<option value="3" <?php if ($this->_var['user']['fenxiao_rank'] == 3): ?> selected="selected"<?php endif; ?>><?php echo $this->_var['user']['fenxiao_rank_name']['2']; ?></option>
<option value="4" <?php if ($this->_var['user']['fenxiao_rank'] == 4): ?> selected="selected"<?php endif; ?>><?php echo $this->_var['user']['fenxiao_rank_name']['3']; ?></option>
<option value="5" <?php if ($this->_var['user']['fenxiao_rank'] == 5): ?> selected="selected"<?php endif; ?>><?php echo $this->_var['user']['fenxiao_rank_name']['4']; ?></option>
<option value="6"  <?php if ($this->_var['user']['fenxiao_rank'] == 6): ?> selected="selected"<?php endif; ?>><?php echo $this->_var['user']['fenxiao_rank_name']['5']; ?></option>

</select>
&nbsp;&nbsp;&nbsp;&nbsp;
  
锁死：
<input type="radio" <?php if ($this->_var['user']['fenxiao_rank_mark'] == 1): ?>checked="checked"<?php endif; ?> name="suosi" value="1" />

&nbsp;&nbsp;&nbsp;&nbsp;
正常：
<input type="radio"  <?php if ($this->_var['user']['fenxiao_rank_mark'] == 0): ?>checked="checked"<?php endif; ?>  name="suosi" value="0" />
         </td>   
