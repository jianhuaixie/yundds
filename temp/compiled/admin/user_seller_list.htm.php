...
?>
    <tr>
      ...
      <td align="center">
        ...
        <a href="javascript:void(0);" onclick="listTable.remove(<?php echo $this->_var['user_seller']['id']; ?>, '<?php echo $this->_var['lang']['drop_confirm']; ?>')" title="<?php echo $this->_var['lang']['remove']; ?>"><?php echo $this->_var['lang']['remove']; ?></a></td>
    </tr>
    <?php endforeach; else: ?>
