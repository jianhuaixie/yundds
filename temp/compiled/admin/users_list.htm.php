...
<div class="form-div">
  <form action="javascript:searchUser()" name="searchForm">
    ...
    &nbsp;<?php echo $this->_var['lang']['label_pay_points_gt']; ?>&nbsp;<input type="text" name="pay_points_gt" size="8" />
    &nbsp;<?php echo $this->_var['lang']['label_pay_points_lt']; ?>&nbsp;<input type="text" name="pay_points_lt" size="10" />
    &nbsp;<?php echo $this->_var['lang']['label_user_name']; ?>&nbsp;<input type="text" name="keyword" />
    &nbsp;会员ID&nbsp;<input name="member_id" />
...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th align="left"><a href="javascript:listTable.sort('user_name'); ">账号</a><?php echo $this->_var['sort_user_name']; ?></th>
    <th align="left">昵称</th>
    <th align="left">头像</th>
    <th align="left" style="color:#F00;"><a href="javascript:listTable.sort('parent_id'); " style="color:#F00;">上家ID</a><?php echo $this->_var['sort_parent_id']; ?></th>
    <th align="left" style="color:#F00;">上家昵称</th>
    <th align="left" style="color:#F00;">上家头像</th>
    ...
    <th align="left"><?php echo $this->_var['lang']['user_money']; ?></th>
    <th align="left"><?php echo $this->_var['lang']['frozen_money']; ?></th>
    <th align="left"><?php echo $this->_var['lang']['rank_points']; ?></th>
    <th align="left"><?php echo $this->_var['lang']['pay_points']; ?></th>
...
?>
  <tr>
    ...
    <td><?php echo htmlspecialchars($this->_var['user']['wx_nickname']); ?></td>
    <td><img src="<?php echo $this->_var['user']['wx_headimgurl']; ?>" width="50" height="50"></td>
    <td><?php echo $this->_var['user']['parent_id']; ?></td>
    <td><?php if ($this->_var['user']['parent_id'] > 0): ?><?php echo $this->_var['user']['wx_p_nickname']; ?><?php endif; ?></td>
    <td><?php if ($this->_var['user']['parent_id'] > 0): ?><img src="<?php echo $this->_var['user']['wx_p_headimgurl']; ?>" width="50" height="50"><?php endif; ?></td>
...
function searchUser()
{
	...
	listTable.filter['member_id'] = Utils.trim(document.forms['searchForm'].elements['member_id'].value);//hzh
