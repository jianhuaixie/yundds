      ...
      <form enctype="multipart/form-data" action="" method="post" name="theForm" >
        ...
        <table width="90%" id="general-table" align="center">
          <tr>
            ...
            <?php echo $this->_var['lang']['require_field']; ?></div></td>
          </tr>
          <tr>
            <td class="label">
        ...
        <?php echo $this->html_options(array('options'=>$this->_var['suppliers_list_name'],'selected'=>$this->_var['goods']['suppliers_id'])); ?>
         ...
         <!--hzh s-->
          <tr>
            ...
            <td><input type="text" name="cost_price" value="<?php echo $this->_var['goods']['cost_price']; ?>" size="20"/></td>
          </tr>
          <!--hzh e-->
          <tr>
		  ...
		  <!--新增分成金额设定 hzh-->
          <tr>
            <td class="label"><font style="color:#F00;">用于模式 1 分成的金额百分比：</font></td>
            <td><input type="text" name="fencheng1" value="<?php echo $this->_var['goods']['fencheng1']; ?>" size="20" /> （请输入 0~1 之间的数字）
            <br /><span class="notice-span" <?php if ($this->_var['help_open']): ?>style="display:block" <?php else: ?> style="display:none" <?php endif; ?> id="rankIntegral">该商品出售后，需要用于模式 1 分成的金额百分比，比如输入0.3 则表示30%</span></td>
          </tr>
          <tr>
            <td class="label"><font style="color:#F00;">用于模式 2 分成的金额百分比：</font></td>
            <td><input type="text" name="fencheng2" value="<?php echo $this->_var['goods']['fencheng2']; ?>" size="20" /> （请输入 0~1 之间的数字）
            <br /><span class="notice-span" <?php if ($this->_var['help_open']): ?>style="display:block" <?php else: ?> style="display:none" <?php endif; ?> id="rankIntegral">该商品出售后，需要用于模式 2 分成的金额百分比，比如输入0.3 则表示30%</span></td>
          </tr>
...
?>
          ...
          <!--hzh s-->
          <tr>
            <td class="label"><a href="javascript:showNotice('giveIntegral2');" title="<?php echo $this->_var['lang']['form_notice']; ?>"><img src="images/notice.gif" width="16" height="16" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>"></a>赠送消费积分数：</td>
            <td><input type="text" name="give_integral_rate" value="<?php echo $this->_var['goods']['give_integral_rate']; ?>" size="20" onblur="give_integralSetted()"/> % （本店售价的百分比）
            <br /><span class="notice-span" <?php if ($this->_var['help_open']): ?>style="display:block" <?php else: ?> style="display:none" <?php endif; ?> id="giveIntegral2">赠送积分百分比（按本店售价为基准）</span></td>
          </tr>
          <!--hzh e-->
          <tr style="display:none;">
          ...
          <!--hzh s-->
          <tr>
            <td class="label"><a href="javascript:showNotice('noticPoints_rate');" title="<?php echo $this->_var['lang']['form_notice']; ?>"><img src="images/notice.gif" width="16" height="16" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>"></a> <?php echo $this->_var['lang']['lab_integral']; ?></td>
            <td><input type="text" name="integral_rate" value="<?php echo $this->_var['goods']['integral_rate']; ?>" size="20" onblur="parseint_integral_rate()";/> % （本店售价的百分比）
              <br /><span class="notice-span" <?php if ($this->_var['help_open']): ?>style="display:block" <?php else: ?> style="display:none" <?php endif; ?> id="noticPoints_rate">购买该商品时最多可以使用积分的金额（本店售价的百分比）</span>
            </td>
          </tr>
          <!--hzh e-->
          <tr style="display:none;">
          ...
          <tr>
            <td class="label" style="color:#F00;">商品主图：</td>
            <td>
              ...
              <?php endif; ?>
              <br /><span style="display:none;"><input type="text" size="40" value="<?php echo $this->_var['lang']['lab_picture_url']; ?>" style="color:#aaa;" onfocus="if (this.value == '<?php echo $this->_var['lang']['lab_picture_url']; ?>'){this.value='http://';this.style.color='#000';}" name="goods_img_url"/></span>
            </td>
          </tr>
...
?>
                      <div id="gallery_<?php echo $this->_var['img']['img_id']; ?>" style="float:left; text-align:center; border: 1px solid #DADADA; margin: 4px; padding:2px;">
                        <a href="javascript:;" onclick="if (confirm('<?php echo $this->_var['lang']['drop_img_confirm']; ?>')) dropImg('<?php echo $this->_var['img']['img_id']; ?>')">[ 删除 ]</a><br />
                        <a href="goods.php?act=show_image&img_url=<?php echo $this->_var['img']['img_url']; ?>" target="_blank"><img src="../<?php if ($this->_var['img']['thumb_url']): ?><?php echo $this->_var['img']['thumb_url']; ?><?php else: ?><?php echo $this->_var['img']['img_url']; ?><?php endif; ?>" width="100" border="0" /></a><br />
                        <span style="margin-top:5px;display:block;">排序：<input type="text" value="<?php echo htmlspecialchars($this->_var['img']['img_sort']); ?>" size="5" name="old_img_sort[<?php echo $this->_var['img']['img_id']; ?>]" /></span>
                  ...
                  <!-- 涓婁紶鍥剧墖 -->
                  <tr>
                    <td style="width:70%;margin-left:30%">
                      <a href="javascript:;" onclick="addImg(this)">[+]</a>
                      <span style="display:none;"><?php echo $this->_var['lang']['img_desc']; ?> <input type="text" name="img_desc[]" size="20" /></span>
                      <?php echo $this->_var['lang']['img_url']; ?> <input type="file" name="img_url[]" /><input type="text" size="40" value="<?php echo $this->_var['lang']['img_file']; ?>" style="color:#aaa;" onfocus="if (this.value == '<?php echo $this->_var['lang']['img_file']; ?>'){this.value='http://';this.style.color='#000';}" name="img_file[]"/>
                    </td>
                  </tr>
                  <tr><td>&nbsp;</td></tr>
                  <tr><td>&nbsp;</td></tr>
...
?>
  ...
  function validate(goods_id)
  {
	  ...
	  //hzh s
	  if (document.forms['theForm'].elements['fencheng1'].value > 1 || document.forms['theForm'].elements['fencheng1'].value < 0)
      {
          validator.addErrorMsg('模式1分成比例范围为：0至1');
      }
	   if (document.forms['theForm'].elements['fencheng2'].value > 1 || document.forms['theForm'].elements['fencheng2'].value < 0)
      {
          validator.addErrorMsg('模式2分成比例范围为：0至1');
      }
	  /*if (document.forms['theForm'].elements['give_integral_rate'].value > 100 || document.forms['theForm'].elements['give_integral_rate'].value < 0.5)
      {
          validator.addErrorMsg('赠送消费积分百分比范围为：0.5至100');
      }*/
	  //hzh e
  ...
  function priceSetted()
  {
   ...
   // computePrice('integral', integralPercent / 100);//hzh
...
?>
   ...
   * hzh
   */
  function give_integralSetted()
  {
	var integralRate = document.forms['theForm'].elements['give_integral_rate'].value/100;
	document.forms['theForm'].elements['give_integral'].value = document.forms['theForm'].elements['shop_price'].value * integralRate;
  }
  function parseint_integral_rate()
  {
	var parseint_integral_rate = document.forms['theForm'].elements['integral_rate'].value/100;
	var new_integral = document.forms['theForm'].elements['shop_price'].value * parseint_integral_rate;
	//document.forms['theForm'].elements['integral'].value = document.forms['theForm'].elements['shop_price'].value * parseint_integral_rate;
	document.forms['theForm'].elements['integral'].value = parseInt(new_integral);
  }
